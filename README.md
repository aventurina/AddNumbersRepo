...
If the question being answered has already been previously answered correctly, then a server response status code of 400 and a message like below are sent back to the customer:
